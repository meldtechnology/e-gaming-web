...
export const UserMetrics = ({ totalUsersText = "Total Users", userCount = "24", bkgColor, ...props }) => {
  return (
    <div {...props} className={`${props.className} flex items-center w-[32%] md:w-full`}>
      <div className="flex w-full items-start justify-between gap-5 bg-surface px-3 py-9 sm:py-5">
        ...
        <div className="flex w-[65%] flex-col items-start">
          ...
          <Heading size="headingxl" as="h1" className="text-[36px] font-bold text-text-primary">
            {userCount}
          </Heading>
        </div>
      </div>

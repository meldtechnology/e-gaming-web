...
export const MeldAlert = ({ alertType, message }) => {

  if(alertType === AlertType.ERROR) {
    return (
      <div className="w-full animate-bounce text-justify text-[#FF0000] bg-[#DB1402] bg-opacity-[30%] rounded-2xl border border-[#AB0E00] p-4">
      <span>
    ...
    return (
      <div className="w-full animate-bounce text-justify text-[#000066] bg-[#0049E5] bg-opacity-[30%] rounded-2xl border border-[#0A44C2] p-4">
      <span>

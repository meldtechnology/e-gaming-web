    ...
    <div className="w-full min-w-[200px] my-2">
      <div className="relative">
        ...
        <div className="absolute top-2 right-0 flex items-center pr-3">
          <div className="h-6 border-l border-border mr-2"></div>
          <button id="dropdownButton"
                  className="h-full text-sm flex justify-center items-center bg-transparent text-text-primary focus:outline-none">
          ...
          <div id="dropdownMenu"
               className="min-w-[150px] overflow-hidden absolute left-0 w-full mt-10 hidden bg-surface border border-border rounded-md shadow-lg z-10">
            <ul id="dropdownOptions">
              <li className="px-4 py-2 text-text-secondary hover:bg-surface-muted text-sm cursor-pointer" data-value="USD">USD
              </li>
              <li className="px-4 py-2 text-text-secondary hover:bg-surface-muted text-sm cursor-pointer" data-value="EUR">EUR
              </li>
              <li className="px-4 py-2 text-text-secondary hover:bg-surface-muted text-sm cursor-pointer" data-value="CAD">CAD
              </li>
              <li className="px-4 py-2 text-text-secondary hover:bg-surface-muted text-sm cursor-pointer" data-value="RON">RON
              </li>
            </ul>
          </div>
        </div>
